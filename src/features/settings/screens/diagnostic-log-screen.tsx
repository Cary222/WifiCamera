    ...
    <>
      ...
      <View className="flex-1 bg-white dark:bg-[#090A0C]">
        ...
        <View className="px-5 pb-3">
          <Text className="text-sm text-neutral-500 dark:text-neutral-400">保留最近 500 条操作与链路记录，错误日志会安全轮转保存</Text>
          <View className="mt-3 flex-row gap-2">
            ...
            >
              <Text className="text-xs text-neutral-700 dark:text-white">复制日志</Text>
            </Pressable>
            <Pressable
            ...
            >
              <Text className="text-xs font-medium text-black">{isExporting ? '导出中…' : '导出分享'}</Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
          ...
          {feedback && <Text className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">{feedback}</Text>}
        </View>
